                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-select" name="username" id="select1" required>
                                                            <option selected disabled value="">NRP Mahasiswa</option>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPembimbing1">Pembimbing 1</label>
                                                            <br>
                                                        {{-- {!!
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPembimbing2">Pembimbing 2</label>
                                                            <br>
                                                        {{-- {!!
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPenguji1">Penguji 1</label>
                                                            <br>
                                                        {{-- {!!
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPenguji2">Penguji 2</label>
                                                            <br>
                                                        {{-- {!!
