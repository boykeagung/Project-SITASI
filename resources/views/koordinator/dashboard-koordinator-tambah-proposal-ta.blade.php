...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        {{-- {!! Form::Open(['url'=>'dashboard-koordinator-proposal-ta/proposal'])!!} --}}

        <!-- Main Content -->
        <div class="main-content">
            <div class="card card-primary">
                <form class="needs-validation" action="dashboard-koordinator-proposal-ta/proposal" method="POST" enctype="multipart/form-data" novalidate>
                    {{ csrf_field() }}
                        ...
                        <div class="accordion-pendaftaran">
                            <div class="accordion-pendaftaran-item">
                                <div class="accordion-pendaftaran-header card-header p-0">
                                    <h4>Daftar Judul Tugas Akhir </h4>
                                </div>
                                        ...
                                        <div class="data-mahasiswa">
                                            <div class="form-group">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputProposal">Upload Proposal Tugas Akhir</label>
                                                        <br>
                                                        {{-- <br>{!!
                                                        Form::file('proposal')!!}
                                                        <br> --}}
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputJamSidang">Jam Sidang</label>
                                                        <br>
                                                        {{-- {!!
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputTanggal">Tanggal Sidang</label>
                                                        <br>
                                                        {{-- {!!
