...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        {{-- {!! Form::model($seminar,['url'=>'dashboard-koordinator-seminar-ta/'.$seminar->id,'method'=>'PUT'])!!} --}}


        <!-- Main Content -->
        <div class="main-content">
            <div class="card card-primary">
                <form class="needs-validation" action="{{ url('dashboard-koordinator-seminar-ta',$seminar->id)}}" method="POST"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-select" name="id_ta" id="select1" required>
                                                            <option selected>{{$seminar->id_ta}}</option>
                                                            @foreach($ta as $ta)
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="judul"
                                                            value="{{$seminar->judul}}" placeholder="Judul Tugas Akhir">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputDraft">Jurnal Tugas Akhir</label><br>
                                                        {{-- <br>{!!
                                                        Form::file('draft')!!}
                                                        <br> --}}
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="ruangan"
                                                            value="{{$seminar->ruangan}}" placeholder="Ruangan">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="time" class="form-control" name="jam_seminar"
                                                            value="{{$seminar->jam_seminar}}" placeholder="Jam Seminar">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea type="text" class="form-control" name="komentar1"
                                                            rows="3"
                                                            placeholder="Komentar">{{$seminar->komentar1}}</textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea type="text" class="form-control" name="komentar2"
                                                            rows="3"
                                                            placeholder="Komentar">{{$seminar->komentar2}}</textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
