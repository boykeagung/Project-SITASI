...
<head>
    ...
    <title>Sistem Administrasi Tugas Akhir</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="/">Sistem Tugas Akhir</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link" href="#skema-tugas-akhir">Skema TA</a></li>
                    <li class="nav-item"><a class="nav-link" href="#langkah-sidang">Langkah Sidang</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="login-tu">TU</a></li>
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Welcome To Sistem Tugas Akhir Itenas!</div>
            <div class="masthead-heading text-uppercase">Start Your Thesis Journey Now!</div>
            <a class="btn btn-primary btn-xl text-uppercase" href="#skema-tugas-akhir">Lihat Skema</a>
        </div>
    </header>
    <!-- Services-->
    <section class="page-section" id="skema-tugas-akhir">
        <div class="container">
            ...
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Skema Tugas Akhir</h2>
                <h3 class="section-subheading text-muted">Pelajari Skema Tugas Akhir Di Bawah Ini!</h3>
            </div>
            <ul class="timeline">
                <li>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Copyright &copy; Institut Teknologi Nasional Bandung 2022</div>
