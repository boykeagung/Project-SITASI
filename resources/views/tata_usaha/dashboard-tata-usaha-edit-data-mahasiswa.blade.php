    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-content">
            <div class="card card-primary">
                <form class="needs-validation" action="{{ url('dashboard-tata-usaha',$user->id)}}" method="POST" 
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="username" placeholder="NRP " value="{{$user->username}}" required>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="file" class="form-control" name="foto" placeholder="Foto" value="/Foto_Mahasiswa/{{$user->foto}}">
                                        {{-- {!!
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputNo_hp" class="form-label">No Handphone</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputNo_wa" class="form-label">No Whatsapp</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="double" class="form-control" name="ipk" placeholder="IPK" value="{{$user->ipk}}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="sks" placeholder="SKS" value="{{$user->sks}}">
                                    </div>
