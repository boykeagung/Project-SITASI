    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-content">
            <div class="card card-primary">
                <form class="needs-validation" action="dashboard-tata-usaha-tambah-data-mahasiswa" method="POST" enctype="multipart/form-data" novalidate>
                    {{ csrf_field() }}
                    <div class="card-header row">
                        <h3 class="section-title col-8">Tambah Data Mahasiswa</h2>
                    </div>
                    @if(count($errors) > 0)
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="username" placeholder="NRP " required>
