<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <h4> </h4>
            <a href=<?php echo url('dashboard-tata-usaha'); ?>><img width="120" src="/assets/img/logo-v2.png"></a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href=<?php echo url('dashboard-tata-usaha'); ?>><i class="fas fa-th-large"></i>
                    <span>Daftar Mahasiswa</span></a></li>
            <li class="menu-header">Management Tugas Akhir</li>
            <li><a class="nav-link" href=<?php echo url('dashboard-tata-usaha-proposal-ta'); ?>><i class="fas fa-sticky-note"></i> <span>Proposal Tugas
                        Akhir</span></a></li>
