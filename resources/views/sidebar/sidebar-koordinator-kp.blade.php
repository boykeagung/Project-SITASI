<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href=<?php echo url('dashboard-koordinator-kp'); ?>><i class="fas fa-sticky-note"></i> <span>Permohonan Surat
                        Rekomendasi</span></a></li>
            <li><a class="nav-link" href=<?php echo url('dashboard-koordinator-kp'); ?>><i class="fas fa-sticky-note"></i> <span>Daftar Kerja
                        Praktik</span></a></li>
            <li><a class="nav-link" href=<?php echo url('dashboard-koordinator-sidang-kp'); ?>><i class="fas fa-book-open"></i> <span>Sidang Kerja
                        Praktik</span></a></li>
            </li>
        </ul>
    </aside>
