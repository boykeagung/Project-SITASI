    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('dashboard-dospenguji-seminar-ta') ? 'active' : '' }}"><a class="nav-link"
                    ...
                    <span>Seminar Tugas
                        Akhir</span></a></li>
            <li class="{{ Request::is('dashboard-dospenguji-sidang-ta') ? 'active' : '' }}"><a class="nav-link"
                    href=<?php echo url('dashboard-dospenguji-sidang-ta'); ?>><i class="fas fa-book-reader"></i>
                    <span>Sidang Tugas
                        Akhir</span></a></li>
