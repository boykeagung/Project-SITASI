...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        {{-- {!! Form::Open(['url'=>'dashboard-koordinator-tambah-data-mahasiswa'])!!} --}}


        <!-- Main Content -->
        <div class="main-content">
            <div class="card card-primary">
                <form class="needs-validation" action="dashboard-koordinator-tambah-data-mahasiswa" method="POST" enctype="multipart/form-data" novalidate>
                    {{ csrf_field() }}
