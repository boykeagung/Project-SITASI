...
class DospemProposalController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('dosen_pembimbing_penguji.dashboard-dospem-edit-proposal-ta', $data);
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('dashboard-dospem-proposal-ta');
    }
}
