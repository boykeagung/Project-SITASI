...
class DospengProposalController extends Controller
{
    ...
    {
        $data['proposal'] = Proposal::join('ta', 'proposal.id_ta', '=', 'ta.id_ta')
            ->select('proposal.*', 'ta.penguji1')
            ->find($id);
        return view('dosen_pembimbing_penguji.dashboard-dospenguji-edit-proposal-ta', $data);
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('dashboard-dospenguji-proposal-ta');
    }
}
